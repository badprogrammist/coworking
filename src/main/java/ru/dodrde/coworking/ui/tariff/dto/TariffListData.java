 ...
 * @author Ильдар
 */
public class TariffListData extends DTO {
    ...
    public TariffListData(Long id,String title,String price,Integer periodQuantity,String durationPeriod) {
        super(id);
        this.title = title;
        this.price = price;
