...
public class DefaultTariffService extends AbstractCRUDService<Tariff> implements TariffService {
    ...
    public void createTariff(TariffDescription description, Duration duration, BigDecimal price,PlaceAttachStatus placeAttachStatus, List<Option> options) {
        Tariff tariff = new Tariff(description, duration, price,placeAttachStatus);
    ...
    public void updateTariff(Tariff tariff, List<Option> options) {
        intersectOptions(tariff, options);
        update(tariff);
    }
    
    private void intersectOptions(Tariff tariff, List<Option> options) {
